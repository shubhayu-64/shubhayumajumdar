...
const About = () => {
  ...
  const skills = ['Python', 'Django', 'FastAPI', 'SQL', 'NoSQL', 'Google Cloud Platform','MongoDB','Pytorch'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hello! My name is Shubhayu and I enjoy creating things that live on the internet. My 
              interest in computers started back in 2017 when I decided to try playing with websites 
              and apps — turns out hacking into websites and webapps taught me a lot about backend and 
              networks!
            </p>
